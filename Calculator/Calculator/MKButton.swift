    ...
    init(title:String) {
        ...
        */
        if title == "+" {
            ...
            self.type = CalculatorSymbol.One(value: title)
        } else if (title == "2") {
            self.type = CalculatorSymbol.Two(value: title)
        } else if (title == "3") {
            self.type = CalculatorSymbol.Three(value: title)
        } else if (title == "4") {
            self.type = CalculatorSymbol.Four(value: title)
        } else if (title == "5") {
            self.type = CalculatorSymbol.Five(value: title)
        } else if (title == "6") {
            self.type = CalculatorSymbol.Six(value: title)
        } else if (title == "7") {
            self.type = CalculatorSymbol.Seven(value: title)
        } else if (title == "8") {
            self.type = CalculatorSymbol.Eight(value: title)
        } else if (title == "9") {
            self.type = CalculatorSymbol.Nine(value: title)
        } else if (title == "0") {
            self.type = CalculatorSymbol.Zero(value: title)
        } else {
            print("error title")
            self.type = CalculatorSymbol.Zero(value: title)
        }
